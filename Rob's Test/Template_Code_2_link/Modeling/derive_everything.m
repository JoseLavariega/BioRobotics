...
% Write a function to evaluate th1e energy of th1e system given th1e current state and parameters
matlabFunction(E,'file',[directory 'energy_' name],'vars',{z p});
% Write a function to evaluate th1e A matrix of th1e system given th1e current state and parameters
